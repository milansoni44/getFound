          ...
          <table class="table" id="table2">
              ...
              <tbody>
                ...
                <tr class="odd gradeX">
					...
					<td><a href="editAdmin.php?id=<?php echo $row['admin_id']; ?>"><i class="fa fa-pencil"></i><a> <a style="padding-left:20px;" href="deleteAdmin.php?id=<?php echo $row['admin_id']; ?>"><i class="fa fa-trash-o"></i></a> </td>
                </tr>
                <?php 
                    }
                ?>
