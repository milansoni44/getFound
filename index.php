...
?>
    ...
    <div class="contentpanel">
        <?php
            ...
            $sql = "select reports.*,client.deal_title from reports join client ON client.client_id = reports.client_id where client.client_id=".$_SESSION['admin_id']. " ORDER BY reports.report_id desc limit 1";
            ...
            <div class="panel-heading">
              ...
              <div class="stat">
                <div class="row">
                  ...
                  <div class="col-xs-8">
                    <small class="stat-label">Google+ Page Views</small>
                    <h1><?php echo $row['google_listing_views']; ?></h1>
                  </div>
                </div><!-- row -->
            ...
            <div class="panel-heading">
              ...
              <div class="stat">
                <div class="row">
                  ...
                  <div class="col-xs-8">
                    <small class="stat-label">Tracked Calls</small>
                    <h1><?php echo $row['tracked_calls']; ?></h1>
                  </div>
                </div><!-- row -->
            ...
            <div class="panel-heading">
              ...
              <div class="stat">
                <div class="row">
                  ...
                  <div class="col-xs-8">
                    <small class="stat-label">Website Views</small>
                    <h1><?php echo $row['website_views']; ?></h1>
                  </div>
                </div><!-- row -->
              </div><!-- stat -->
            ...
            <div class="panel-heading">
              ...
              <div class="stat">
                <div class="row">
                  ...
                  <div class="col-xs-8">
                    <small class="stat-label">Directory Submission</small>
                    <h1><?php echo $row['published_directory']; ?></h1>
                  </div>
                </div><!-- row -->
      ...
      <div class="row">
          <div class="panel panel-default">
            <div class="panel-heading">
                <h3 class="panel-title"><span style="color:red"> Remarks from latest report by LocalVerifications</span></h3>
            </div> 
      ...
      <div class="panel panel-default">
        ...
        <div class="panel-body">
          ...
          <table class="table" id="table2">
              ...
              <tbody>
                <?php 
                    //$sql = "select reports.*,client.deal_title from reports join client ON client.client_id = reports.client_id where client.deal_id=".$_SESSION['deal'];
                      if($_SESSION['usertype'] == 'admin'){
                         $sql = "select reports.*,client.deal_title from reports join client ON client.client_id = reports.client_id";    
                     }else{
                          $sql = "select reports.*,client.deal_title from reports join client ON client.client_id = reports.client_id where client.client_id=".$_SESSION['admin_id']." status ='enable'";
                     }
                    $result = $dbh->query($sql);
                    foreach($result as $row){
                ...
                ?>                
                    ...
                    <?php 
                        if($_SESSION['usertype'] == 'admin'){
                    ?>
                    <td> <a href="editReport.php?id=<?php echo $row['report_id']; ?>">Edit</a> <a href="viewReport.php?id=<?php echo $row['report_id']; ?>">View Report</a> </td>
                    <?php 
                        }else{
                    ?>
                    <td> <a href="viewReport.php?id=<?php echo $row['report_id']; ?>">View</a> </td>
                    <?php
                        }
                    ?>
                </tr>
              ...
              <tbody>
                ...
                <tr class="odd gradeX">
                    ...
                    <?php 
                        if($_SESSION['usertype'] == 'admin'){
                    ?>
                    <td> <a href="editReport.php?id=<?php echo $row['report_id']; ?>">Edit</a> <a href="viewReport.php?id=<?php echo $row['report_id']; ?>">View</a> </td>
                    <?php 
                        }else{
                    ?>
                    <td> <a href="viewReport.php?id=<?php echo $row['report_id']; ?>">View</a> </td>
