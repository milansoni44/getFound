...
require_once dirname(__FILE__) . '/AssertionCredentials.php';
require_once dirname(__FILE__) . '/Exception.php';
require_once dirname(__FILE__) . '/LoginTicket.php';
require_once dirname(dirname(__FILE__)) . '/Client.php';
require_once dirname(dirname(__FILE__)) . '/Http/Request.php';
require_once dirname(dirname(__FILE__)) . '/Utils.php';
require_once dirname(dirname(__FILE__)) . '/Verifier/Pem.php';
